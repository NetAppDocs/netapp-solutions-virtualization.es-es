...
----
** Se agregaron 2 bases de datos, se agregó 1 tabla y 1 fila en la tabla. Referirselink:https://docs.redhat.com/en/documentation/red_hat_enterprise_linux/9/html/configuring_and_using_database_servers/using-postgresql_configuring-and-using-database-servers#configuring-postgresql_using-postgresql["aquí"] para obtener instrucciones sobre cómo instalar el servidor PostgreSQL en RHEL y crear entradas de bases de datos y tablas.
