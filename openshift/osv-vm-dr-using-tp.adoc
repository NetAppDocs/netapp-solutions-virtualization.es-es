...
---
= Configura el failover y failback para VMs en Red Hat OpenShift Virtualization usando Trident Protect
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
* Trident Protect debe estar instalado para implementar las operaciones de failover y failback para las VMs de OpenShift. Consulta las instrucciones aquí para link:https://docs.netapp.com/us-en/trident/trident-protect/trident-protect-installation.html["instala Trident Protect"]


image:redhat-openshift-ocpv-tp-001.png["OCP-v Trident Protect instalado en el namespace trident-protect"]
...
Esta sección muestra cómo configurar un objeto AppVault en Trident Protect usando el almacenamiento de objetos ONTAP S3.

Usa los comandos oc y los archivos yaml que se muestran abajo para crear un secreto y el recurso personalizado AppVault para ONTAP s3. Asegúrate de crearlos en el namespace trident protect.
...
image:redhat-openshift-ocpv-tp-002.png["OCP-v AppVault en el namespace trident-protect"]



== Crea una app Trident Protect para la máquina virtual
...
== Crea una app Trident Protect para la máquina virtual de recuperación ante desastres en un nuevo espacio de nombres
