...
.Pasos
. Instala OpenShift Cluster versión 4.19 siguiendo las instrucciones en la documentación de Red Hat: https://docs.redhat.com/en/documentation/openshift_container_platform/4.19#Install["Instalación de OpenShift Container Platform"].
