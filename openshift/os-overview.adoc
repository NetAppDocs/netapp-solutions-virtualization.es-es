...
. Sigue la link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.22#Install["instrucciones de instalación"] proporcionada por Red Hat para implementar en el entorno que elijas.
