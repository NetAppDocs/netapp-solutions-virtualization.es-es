...
[%collapsible%open]
====
Las soluciones de protección de datos 3-2-1 combinan copias de seguridad primarias y secundarias locales, mediante tecnología SnapMirror , con copias replicadas en el almacenamiento de objetos mediante NetApp Backup and Recovery.
