...
Para obtener más información sobre la creación de políticas, consulte https://docs.netapp.com/us-en/bluexp-backup-recovery/prev-vmware-policy-create.html["Crear una política para realizar copias de seguridad de almacenes de datos"] .
...
Para obtener más información, consulte https://docs.netapp.com/us-en/bluexp-backup-recovery/prev-vmware-backup-aws.html["Realizar copias de seguridad de almacenes de datos en Amazon Web Services"] .
...
Para obtener más información, consulte https://docs.netapp.com/us-en/bluexp-backup-recovery/prev-vmware-restore.html["Restaurar datos de máquinas virtuales desde la nube"] .
