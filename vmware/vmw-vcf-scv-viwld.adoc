...
TIP: Además de replicar copias de seguridad realizadas con SCV en un almacenamiento secundario, se pueden realizar copias de datos externas en un almacenamiento de objetos en uno de los tres (3) proveedores de nube líderes que utilizan NetApp Backup and Recovery para máquinas virtuales. Para obtener más información consulte esta oferta.link:https://docs.netapp.com/us-en/data-services-backup-recovery/index.html["Documentación de NetApp Backup and Recovery"] .
