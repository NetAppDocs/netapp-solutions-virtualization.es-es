...
---
= Migrar máquinas virtuales a Microsoft Hyper-V mediante el script de PowerShell
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Utilice el script de PowerShell para migrar máquinas virtuales de VMware vSphere a Microsoft Hyper-V mediante la tecnología FlexClone .  El script agiliza el proceso de migración al conectarse a clústeres de vCenter y ONTAP , crear instantáneas, convertir VMDK a VHDX y configurar máquinas virtuales en Hyper-V.
