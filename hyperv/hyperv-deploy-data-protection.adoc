...
Para conocer los pasos detallados sobre cómo configurar la matriz, consulte link:https://documentation.commvault.com/v11/commcell-console/configuring_netapp_array_using_array_management.html["Configuración de la matriz NetApp"] y link:https://documentation.commvault.com/v11/commcell-console/configure_storage_virtual_machine_on_netapp_storage_array.html["Configuración de máquinas virtuales de almacenamiento en matrices NetApp"]
...
Para conocer los pasos detallados sobre la configuración de la matriz, consultelink:https://documentation.commvault.com/2023e/software/guided_setup_for_hyper_v.html["Configuración guiada para HyperV"] .
...
Para conocer los pasos detallados para todas las opciones de restauración compatibles, consultelink:https://documentation.commvault.com/2023e/software/restores_for_hyper_v.html["Restauraciones para Hyper-V"] .
