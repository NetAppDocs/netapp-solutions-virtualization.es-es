...
* Los archivos VMDK se pueden configurar de varias formas: todos los archivos VMDK pueden residir en un único volumen (eliminando la necesidad de Storage vMotion), cada archivo VMDK puede ubicarse en su propio volumen individual, o varios archivos VMDK pueden organizarse dentro de un qtree en un volumen.
+

NOTE: El kit de herramientas Shift detecta automáticamente la configuración y selecciona el método de clonación adecuado y los controladores de almacenamiento NAS apropiados.
