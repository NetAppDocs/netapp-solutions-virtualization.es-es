...
NOTE: Cuando se utiliza el almacenamiento FlexGroup, solo se admiten las conversiones en formato RAW. Además, Shift toolkit inyecta los controladores VirtIO durante la preparación al realizar conversiones solo de KVM.
